...
namespace _2018_11_07_계산기만들기_곽정민
{
    public partial class Form1 : Form
    {
        ...
        bool Point_Flag = true; //true 면 점 찍을수 있고 아니면 안 찍힘
        ...
        {
            if((textBox1.Text =="0" && Point_Flag ==true)  || textBox1.Text =="000" || textBox1.Text == "")
                textBox1.Text = "0";
            else
        ...
        private void button17_Click(object sender, EventArgs e) // 곱하기 버튼 X *
        {
            ...
            Newsutja_Flag = false;
            Point_Flag = true;
            //Point_Flag = (int.TryParse(double.Parse(textBox1.Text).ToString(), out sosu));
            label3.Text = Store_Younsanja;
        ...
        private void button19_Click(object sender, EventArgs e) //등호 =
        {
            iOperation();
            EndofCalcNum=true;
            Store_Younsanja = ""; 
       ...
       private void button22_Click(object sender, EventArgs e) // 거듭제곱 버튼 
        ...
        {
            MessageBox.Show("운영 체제 : Windows 7\n개발 도구: Microsoft Visual Studio 2015 & 2017","개발 환경");
        }
